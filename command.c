...
static void show_icon_toggle (GtkToggleButton *button, CommandApplet *command_applet);
...
static void setup_sensitivity(CommandApplet* command_applet, GtkBuilder* builder, const char* wid, const char* label, const char* label_post, const char* key) 
{     
    GtkWidget *w;                                                              
                                                         
    if (g_settings_is_writable (command_applet->settings, key)) {     
        return;       
    }                                 
...
{   
    ...
    tog = gtk_toggle_button_get_active (button);
...
command_settings_callback (GtkAction *action, CommandApplet *command_applet)
{
    ...
    g_signal_connect (command_applet->icon_chooser, "selection-changed",                    
                      G_CALLBACK (icon_name_changed),               
                      command_applet);                                                             
    
    setup_sensitivity (command_applet, builder,                                      
            "icon_entry",    
            "icon_label",    
            NULL,    
            ICON_NAME_KEY); 
    ...
    g_settings_bind (command_applet->settings, ICON_NAME_KEY, GET_WIDGET ("icon_entry"), "name", G_SETTINGS_BIND_DEFAULT);
    ...
    gtk_builder_add_callback_symbols (builder,
                                      ...
                                      "on_show_icon_check_toggled", G_CALLBACK (show_icon_toggle),
                                      NULL);
